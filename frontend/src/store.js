...
// Reducers
import { itemListReducer, itemDetailsReducer, categoryListReducer, configListReducer, responseSetItemReducer } from './reducers/itemReducers';
...
const reducer = combineReducers({
    ...
    responseSetItem: responseSetItemReducer,
